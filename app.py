...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Diệu - Trường Tiểu học Tân Loan - ĐT: 0987699948</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Diệu - Trường Tiểu họcTân Loan- ĐT: 0987699948</div>", unsafe_allow_html=True)
